...
export const SANTA_LIST: Santa[] = [
    ...
    { id: 5, name: 'Mos Craciun', country: 'Romania', description: 'The REAL Santa', photo: 'https://i.imgur.com/Rw3rdov.jpg', song: 'None', wishlist: [GIFT_DICT['Charcoal'], GIFT_DICT['Red Apples']] },
